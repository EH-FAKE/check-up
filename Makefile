...
scrape_agenciagov:
	docker compose exec scraper python scrape_no_openai.py --platform agenciagov.ebc.com.br
...
crawl_agenciagov:
	docker compose run scraper python crawl.py agenciagovspider
...
help:
	...
	@echo "  make crawl_agenciagov    - Coleta URLs do portal Agência Gov"
	@echo ""
	...
	@echo "  make scrape_agenciagov    - Scraping do portal Agência Gov"
	@echo ""
