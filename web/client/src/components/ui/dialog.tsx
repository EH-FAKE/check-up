      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className={cn(
              "ring-offset-background focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-4 right-4 z-10 rounded-sm opacity-70 transition-opacity hover:opacity-100 disabled:pointer-events-none",
              "focus:outline-none focus-visible:ring-2 focus:ring-offset-2",
