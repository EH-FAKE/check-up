...
O repositório EH-FAKE no GitHub é composto por dois sub-repositórios(check-up e airflow-rag) principais, cada um com uma função específica no ecossistema do projeto:
